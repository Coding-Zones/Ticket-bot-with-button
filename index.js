...
client.on('ready', async () => {
  ...
  console.log(`Made by </ Itz_Danny >#3514`)
  console.log(`Credits | </Coding Zone> | https://dsc.gg/codingzone`)
...
> \`${prefix}setstaff\` - set staff roles`)
      .setTimestamp()
      .setColor(0x5865F2)
      .setFooter(`All rights belong to [</Coding Zone>](https://dsc.gg/codingzone)`)
